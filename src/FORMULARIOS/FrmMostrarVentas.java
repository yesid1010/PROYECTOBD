...
public class FrmMostrarVentas extends javax.swing.JInternalFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (txtNombre_cliente.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "El campo cliente no puede estar vacio");
        }
        ...
        Factura_venta factura = new Factura_venta();
        factura.setClinete_cedula(Integer.parseInt(txtNombre_cliente.getText()));
        ...
        factura.setFactura_id(Integer.parseInt(txtCod_venta.getText()));
   ...
   void ocultarcolumnad(int n) {
    ...
    private void btnEliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminar1ActionPerformed
        ...
        detalle.setFactura_id(Integer.parseInt(tabladetalles.getValueAt(i, 5).toString()));
        detalle.setProducto_id(Integer.parseInt(tabladetalles.getValueAt(i, 4).toString()));
        
        int aceptar = JOptionPane.showConfirmDialog(null,"¿seguro que desea ejecutar esta accion?","Advertencia",JOptionPane.YES_NO_OPTION);

...
public class Productotabla extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        FrmVentaDetalle.txtCod_producto.setText(jTable1.getValueAt(fila, 0).toString());
        FrmVentaDetalle.txtNombre_producto.setText(jTable1.getValueAt(fila, 1).toString());
        FrmVentaDetalle.txtPrecio_producto.setText(jTable1.getValueAt(fila, 3).toString());
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productotabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Productotabla().setVisible(true);
            }
        });
    }
